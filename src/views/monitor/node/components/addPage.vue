  ...
  <div>
    ...
    >
      <el-form ref="addFormData" :model="addFormData" label-width="30%" class="demo-ruleForm">
        <el-form-item label="绑定资产: " required prop="host">
        ...
        <el-form-item label="联邦主节点: " required prop="master">
          <el-switch
            v-model="addFormData.master"
            active-color="#13ce66"
        ...
        <el-form-item label="配置文件路径: " required prop="config_path">
          <el-input v-model="addFormData.config_path" style="width: 60%" />
        </el-form-item>
        <el-form-item label="rule文件路径: " required prop="rules_path">
          <el-input v-model="addFormData.rules_path" style="width: 60%" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      dialogCreateTitle: '新增Prometheus节点',
      dialogUpdateTitle: '更新Prometheus节点',
      dialogWidth: '40%',
