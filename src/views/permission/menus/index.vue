  ...
  <div class="data-center-tablemanage">
    ...
    <div class="tablemanage-container">
      ...
      >
        ...
        <el-table-column prop="title" label="名称" width="150px" />
        <el-table-column prop="path" label="路径" width="150px" />
        <el-table-column prop="component" label="VUE文件路径" width="200px" />
        <el-table-column prop="name" label="路由名" width="150px" />
        ...
        <el-table-column show-overflow-tooltip prop="order" label="排序" />
    ...
    <MenuManagementEdit :is-show.sync="isShow" :edit-data="editData" />
  </div>
</template>
<script>
import { PremMenu as masterApi } from '@/api/permission'
import MenuManagementEdit from '../components/MenuManagementEdit'
