  ...
  <div class="authManagement-container">
    <el-row>
      <el-col :xs="24" :sm="24" :md="10" :lg="6" :xl="6" style="padding-left: 10px; padding-right: 10px;">
        <div
          class="tablemanage-operate"
          style="background:#fff;padding-top:10px;display:flex;justify-content:flex-end;"
        >
    ...
    <AuthLeftEdit :is-show.sync="isShowLeftEdit" :edit-data="editDataLeftEdit" />
    <AuthManagementEdit :is-show.sync="isShowTableEdit" :edit-data="editDataTableEdit" />
  </div>
</template>

<script>
import { PremRule as masterApi } from '@/api/permission'
import AuthLeftEdit from '../components/AuthLeftEdit'
import AuthManagementEdit from '../components/AuthManagementEdit'
